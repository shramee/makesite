/**
 * Created by shramee on 20/10/15.
 */
/**
 ...
 *
 * Version: 1.1
 * https://github.com/23r9i0/lib-alpha-color-picker
	...
	$.widget( 'wpd.makesite_iris', $.a8c.iris, {
		_create: function() {
			...
			if ( typeof this.options.alpha !== 'undefined' && this.options.alpha ) {
				var self = this,
					...
					aScreen = $( '<div class="iris-square-inner iris-square-alpha"></div>' ).appendTo( self.picker.find( '.iris-square' ) ),
		...
		_initControls: function() {
			...
			if ( this.options.alpha ) {
				...
				controls.aScreen.css( 'opacity', 1 - parseInt( self._color._alpha ) );
				controls.aSlider.slider({
					...
					slide: function( event, ui ) {
						...
						controls.aScreen.css( 'opacity', 1 - ui.value/100 );
					}
				});
			}
		},
