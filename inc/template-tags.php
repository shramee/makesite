 ...
 * @return bool
 */
function makesite_categorized_blog() {
	if ( false === ( $all_the_cool_cats = get_transient( 'makesite_categories' ) ) ) {
		...
		set_transient( 'makesite_categories', $all_the_cool_cats );
	}

	if ( $all_the_cool_cats > 1 ) {
		// This blog has more than 1 category so makesite_categorized_blog should return true.
		return true;
	} else {
		// This blog has only 1 category so makesite_categorized_blog should return false.
		return false;
	}
}
